...
class Service(dbus.service.Object):
    ...
    def __init__(self):
        bus_name = service.BusName("org.jde.Desktop", dbus.SessionBus())
        service.Object.__init__(self, bus_name, "/org/jde/Desktop")

    @dbus.service.method("org.jde.Desktop", in_signature='', out_signature='')
